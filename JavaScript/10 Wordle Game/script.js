...
let targetWord = targetWords[Math.floor(Math.random()*targetWords.length-1)];
const alertContainer = document.querySelector("[data-alert-container]");
const keyBoard = document.querySelector(".keyBoard");
const Filp_Animation_Duration = 500;
...
function stopInteraction(){
    ...
    newGameBtn.removeEventListener("click", handleNewGameBtn);
}
...
function handleNewGameBtn(){
    ...
    boxes = guessGrid.querySelectorAll('.tile');
    boxes.forEach((box) => {
        box.classList = 'tile';
        box.textContent = "";
...
function flipTile(tile, index, array, guess){
    ...
    }, (index * Filp_Animation_Duration)/2);
